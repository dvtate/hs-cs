...
def draw_reg_poly(t_navn, dist, side_num, color, x0, y0, num_dash):
  '''draw regular polygon
  'params: turtle name, side length, number of sides, color, x, y, number of dashes.
  'draws the described polygon
  '''
...
paint_canvas(wn, 'lightblue');
draw_rectangle(t, -200,-200,200,200, 'red',50);
draw_rectangle(t, -100,-80,90,150,'green', 1);
draw_x(t, -100,-80,90,150,'purple', 1);

draw_reg_poly(t, 20, 6, 'blue', 20, 5,2);